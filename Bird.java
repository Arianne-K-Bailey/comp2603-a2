...
public class Bird extends Animal implements Trackable, Relocatable {
    ...
    public Bird(String species, String nickname, String island, double weightKg, String healthStatus,
        ...
        // M2: Set wingspanCm and canFly
        this.wingspanCm = wingspanCm;
        this.canFly = canFly;
    }

    // M2: Write getWingspanCm() and canFly() getters
    ...
    // M2: Implement getType() - returns "Bird"
    ...
    // --- Trackable methods ---
    // M4: Implement logSighting(String date, String location) - Appends "date at location" to the sightings list
    @Override
    ...
    // M4: Implement getSightingCount() - Returns the size of the sightings list
    @Override
    public int getSightingCount() {
        return getSightings().size();
    }

    // M4: Implement getLastSighting() - Returns the last entry, or "No sightings recorded" if empty
    @Override
